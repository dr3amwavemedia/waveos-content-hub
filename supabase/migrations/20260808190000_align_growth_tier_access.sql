-- Layer 2 mirrors the full client workspace while keeping social connection,
-- scheduling, and publishing locked. Deliveries remain universal to all tiers.
