-- Add a production-only Crew position to the existing staff role system.

ALTER TYPE public.staff_type ADD VALUE IF NOT EXISTS 'crew';
...
BEGIN
  ...
  END IF;
  IF _position NOT IN ('admin', 'sales', 'media_manager', 'crew') THEN
