      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Scheduled content and assigned productions for {activeWorkspace.name}.
          </p>
        </div>
                ...
                <div className="space-y-1">
                  ...
                  {dayProductions.map((production) => (
                    <button
                      ...
                      className="block w-full truncate rounded-md bg-amber-500/15 px-2 py-1 text-left text-[11px] font-medium text-foreground hover:bg-amber-500/25"
                    >
